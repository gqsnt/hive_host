...
pub enum ServerHelperCommand {
    ...
    CreateProject { project_slug: String, service_user: String },
    DeleteProject { project_slug: String },

    SetAcl { path: String,user_slug:UserSlugStr, is_read_only:bool },
    RemoveAcl { path: String, user_slug:UserSlugStr },


    BindMountUserProject { source_path: String, target_path: String },
    UnmountUserProject { target_path: String },
    
    CreateSnapshot { path: String, snapshot_path: String },
    DeleteSnapshot { snapshot_path: String },
    MountSnapshot { path: String, snapshot_name: String },
    UnmountProd{ path: String },
